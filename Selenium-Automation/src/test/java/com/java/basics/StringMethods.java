...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		String sText5 = "The variety and types of email forms that you can create with myContactForm.com are virtually endless. "
				...
				+ "you can create it!";
		String sText6=null; // Null String with no value at all

		System.out.println(sText1.isEmpty()); // Check if string is empty
		System.out.println(sText4.isEmpty());
		//System.out.println(sText6.isBlank()); // Returns true if the string is empty or contains only white space codepoints,otherwise false.
		...
		System.out.println(StringMethods.class);
